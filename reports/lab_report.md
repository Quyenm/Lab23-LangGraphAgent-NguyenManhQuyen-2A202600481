# Day 08 Lab Report — LangGraph Agent Orchestration
...
|----------|---------------|--------------|---------|---------|------------|---------|
| S01_simple | simple | simple | ✅ | 0 | 0 | 16ms |
| S02_tool | tool | tool | ✅ | 0 | 0 | 16ms |
| S03_missing | missing_info | missing_info | ✅ | 0 | 0 | 0ms |
| S04_risky | risky | risky | ✅ | 0 | 1 | 14ms |
| S05_error | error | error | ✅ | 3 | 0 | 16ms |
| S06_delete | risky | risky | ✅ | 0 | 1 | 16ms |
| S07_dead_letter | error | error | ✅ | 1 | 0 | 0ms |

**Summary**:
- Total scenarios: **7**
- Success rate: **100.0%**
- Average nodes visited: **6.6**
- Total retries across all runs: **4**
- Total approval/HITL events: **2**
- Crash-resume demonstrated: **True**
...
Scenarios demonstrating retry: S05_error, S07_dead_letter
...
Scenarios requiring approval: S04_risky, S06_delete
